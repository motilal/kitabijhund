<div class="container">
    <div class="row">
        <!-- Here begin Sidebar -->
        <div class="col-md-4">
            <?php echo sanitize_output($this->layout->element('form_alert/_sidebar', $this->_ci_cached_vars, true)); ?> 
        </div> <!-- /.col-md-4 -->
        ...
        <div class="col-md-8">
            ...
            <div class="row" id="result_data">
                <?php echo sanitize_output($this->layout->element('form_alert/_element_form_alerts_index', $this->_ci_cached_vars, true)); ?>                 
            </div> <!-- /.row -->
