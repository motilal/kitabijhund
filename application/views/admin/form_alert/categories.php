            ...
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <div class="btn-group" data-toggle="btn-toggle">
                        <?php if (is_allow_action('form_alert-category-add')) { ?>
                            <a href="#" data-toggle="modal" data-target="#modal-manage" class="btn btn-primary btn-sm add_new_item"><i class="fa fa-plus"></i> Add New Category </a>
                        <?php } ?>
                    </div>
                </div>
            </div>     
                        ...
                        <?php if ($result->num_rows() > 0) { ?>
                            <?php foreach ($result->result() as $key => $row): ?>
                                <tr id="row_<?php echo $row->id; ?>">
                                    ...
                                    <td>
                                        <?php echo $this->layout->element('admin/element/_module_status', array('status' => $row->status, 'id' => $row->id, 'url' => "admin/form_alerts/category_changestatus", 'permissionKey' => "form_alert-category-status"), true); ?>
                                    </td>
                                    <td>  
                                        <?php echo $this->layout->element('admin/element/_module_action', array('id' => $row->id, 'editUrl' => "admin/form_alerts/category_manage", 'deleteUrl' => 'admin/form_alerts/category_delete', 'editPermissionKey' => 'form_alert-category-edit', 'deletePermissionKey' => 'form_alert-category-delete'), true); ?>
                                    </td>  
                                </tr>
                            <?php endforeach; ?>
                        <?php } ?> 
...
<div class="modal fade" id="modal-manage">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('admin/form_alerts/category_manage', array("id" => "manage-form", "method" => "post")); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group <?php echo form_error('name') != "" ? 'has-error' : ''; ?>">
                            <label class="control-label" for="name">Category Name <em>*</em></label>
...
<script>
     ...
     */
    var datatbl = datatable_init([0, 3], [[1, 'asc']], DEFAULT_PAGING, 1);
