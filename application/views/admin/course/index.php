            ...
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <div class="btn-group" data-toggle="btn-toggle">
                        <?php if (is_allow_action('course-add')) { ?>
                            <a href="#" data-toggle="modal" data-target="#modal-manage" class="btn btn-primary btn-sm add_new_item"><i class="fa fa-plus"></i> Add New Course </a>
                        <?php } ?>
                        <a href="<?php echo site_url('admin/courses?download=report'); ?>" class="btn btn-default btn-sm"><i class="fa fa-download"></i> Export CSV</a>
                    </div>
                </div>
            </div>     
            <!-- /.box-header -->
                        ...
                        <?php if ($result->num_rows() > 0) { ?>
                            <?php foreach ($result->result() as $key => $row): ?>
                                <tr id="row_<?php echo $row->id; ?>">
                                    ...
                                    <td>
                                        <?php echo $this->layout->element('admin/element/_module_status', array('status' => $row->status, 'id' => $row->id, 'url' => "admin/courses/changestatus", 'permissionKey' => "course-status"), true); ?>
                                    </td>
                                    <td>  
                                        <?php echo $this->layout->element('admin/element/_module_action', array('id' => $row->id, 'editUrl' => "admin/courses/manage", 'deleteUrl' => 'admin/courses/delete', 'editPermissionKey' => 'course-edit', 'deletePermissionKey' => 'course-delete'), true); ?>
                                    </td>  
                                </tr>
                            <?php endforeach; ?>
                        <?php } ?> 
...
<div class="modal fade" id="modal-manage">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('admin/courses/manage', array("id" => "manage-form", "method" => "post")); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group <?php echo form_error('name') != "" ? 'has-error' : ''; ?>">
                            <label class="control-label" for="name">Course Name <em>*</em></label>
